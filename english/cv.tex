...
\usepackage[left=0.7cm,right=0.7cm,vmargin=1.2cm]{geometry}
...
\titlespacing{\section}{17pt}{8pt}{5pt} % Spacing around sections
...
\begin{tabular}{p{.14\textwidth} p{.80\textwidth}}
...
\begin{tabular}{p{.14\textwidth} p{.79\textwidth}}
